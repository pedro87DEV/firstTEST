...
Tutti i passi spiegati in questa guida sono implementati in una **[pagina di verifica automatica](https://pedro87DEV.github.io/verifica-notarizzazione-blockchain/)** nella quale si può caricare la ricevuta per la verifica.
